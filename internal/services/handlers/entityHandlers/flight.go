...
func GetAllFlights(c *fiber.Ctx) error {
	...
	return entityTransports.ResponseFlights(c, responseFlights, err)
...
func GetSingleFlight(c *fiber.Ctx) error {
	...
	return entityTransports.ResponseFlight(c, flight, err)

}

func CreateFlight(c *fiber.Ctx) error {

	insertStruct, err := entityTransports.ValidateFlightInsertData(c)
	if err != nil {
		return err
	}

	direction, err := repositories.GetDirection(insertStruct.DirectionID)
	err = entityTransports.ResponseFlightDirectionNotFound(c, direction, err)
	if err != nil {
		return err
	}
	...
	return entityTransports.ResponseFlightCreate(c, err)
...
func UpdateFlight(c *fiber.Ctx) error {
	...
	err = entityTransports.ResponseFlightNotFound(c, flight, err)
	if err != nil {
		return err
	}

	updateStruct, err := entityTransports.ValidateFlightUpdateData(c)
	if err != nil {
		return err
	}
	...
	return entityTransports.ResponseFlightUpdate(c, err)
}
...
func DeleteFlight(c *fiber.Ctx) error {
	...
	return entityTransports.ResponseFlightDelete(c, err)
