...
func GetFlights() (a []*entities.Flight, err error) {
...
func GetFlight(id string) (*entities.Flight, error) {
...
func GetFlightsByOriginCity(originCityID string) (a []*entities.Flight, err error) {
	flights := make([]*entities.Flight, 0)
...
func CreateFlight(flight *entities.Flight) error {
	db := database.DB()
...
func UpdateFlight(flight *entities.Flight) error {
	db := database.DB()
